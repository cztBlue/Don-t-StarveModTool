...
from klei.matrix3 import create_trans_rot_scale_pivot_matrix
        ...
        for entity in scml_root.findall("entity"):
            ...
            for animation in entity.findall("animation"):
                ...
                for mainline_key in mainline_keys:
                    ...
                    assert (time - last_time) % frame_duration == 0, f"{animation_name} error, The frame duration must be {frame_duration}"
                    last_time = time
